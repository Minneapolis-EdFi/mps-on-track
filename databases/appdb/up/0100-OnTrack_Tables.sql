...
IF OBJECT_ID('gradCredits.GradRequirementExecutionLogAudits',N'U') IS NOT NULL
	DROP TABLE gradCredits.GradRequirementExecutionLogAudits
GO


IF OBJECT_ID('gradCredits.GradRequirementExecutionLogDetail',N'U') IS NOT NULL
	DROP TABLE gradCredits.GradRequirementExecutionLogDetail
GO


IF OBJECT_ID('gradCredits.GradRequirementExecutionLog',N'U') IS NOT NULL
	DROP TABLE gradCredits.GradRequirementExecutionLog
GO
...
CREATE TABLE gradCredits.GradRequirementExecutionLog
(
	GradRequirementExecutionLogId INT IDENTITY(1,1) NOT NULL,
	GradRequirementStoredProcedure NVARCHAR(100) NOT NULL,
	ExecutionStart DATETIME NOT NULL,
	ExecutionEnd DATETIME NULL,
	ExecutionStatus NVARCHAR(20) NULL,
	CONSTRAINT PK_GRAD_REQ_EXLOG PRIMARY KEY (GradRequirementExecutionLogId)
)
GO


CREATE TABLE gradCredits.GradRequirementExecutionLogDetail
(
	GradRequirementExecutionLogDetailId INT IDENTITY(1,1) NOT NULL,
	GradRequirementExecutionLogId INT NOT NULL,
	GradRequirementTable VARCHAR(100) NOT NULL,
	RecordsInserted INT NULL,
	RecordsUpdated INT NULL,
	RecordsDeleted INT NULL,
	RecordsAudited INT NULL,
	CONSTRAINT PK_GRAD_REQ_EXLOGDT PRIMARY KEY (GradRequirementExecutionLogDetailId),
	CONSTRAINT FK_GRAD_REQ_EXLOG_LD FOREIGN KEY (GradRequirementExecutionLogId) 
		REFERENCES gradCredits.GradRequirementExecutionLog(GradRequirementExecutionLogId)
)
GO


CREATE TABLE gradCredits.GradRequirementExecutionLogAudits
(
	GradRequirementExecutionLogAuditId INT IDENTITY(1,1) NOT NULL,
	GradRequirementExecutionLogDetailId INT NOT NULL,
	ErrorDetails NVARCHAR(MAX) NOT NULL,
	CONSTRAINT PK_GRAD_REQ_EXLOGAUD PRIMARY KEY (GradRequirementExecutionLogAuditId),
	CONSTRAINT FK_GRAD_REQ_EXLOGAUD_LD FOREIGN KEY (GradRequirementExecutionLogDetailId)
		REFERENCES gradCredits.GradRequirementExecutionLogDetail(GradRequirementExecutionLogDetailId)
)